...
public final class ListOffsetsHandlerTest {
    ...
    private final Map<String, Uuid> topicIdsByName = new HashMap<>() {
        {
            put("t0", Uuid.ZERO_UUID);
            put("t1", Uuid.ZERO_UUID);
            put("t2", Uuid.ZERO_UUID);
        }
    };
    ...
    public void testBuildRequestAllowedVersions() {
        ...
        ListOffsetsHandler readCommittedHandler = newHandler(new ListOffsetsOptions(IsolationLevel.READ_COMMITTED));
