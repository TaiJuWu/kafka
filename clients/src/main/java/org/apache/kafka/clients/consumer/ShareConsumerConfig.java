...
public class ShareConsumerConfig extends AbstractConfig {
    ...
    static {
        CONFIG = new ConfigDef().define(BOOTSTRAP_SERVERS_CONFIG,
                ...
                .define(ShareConsumerConfig.INTERNAL_SHARE_ACKNOWLEDGEMENT_MODE_CONFIG,
                        ConfigDef.Type.STRING,
                        null,
                        in(null, "implicit", "explicit"),
                        ConfigDef.Importance.MEDIUM,
                        ShareConsumerConfig.INTERNAL_SHARE_ACKNOWLEDGEMENT_MODE_DOC);
    }
    ...
    protected Map<String, Object> postProcessParsedConfig(final Map<String, Object> parsedValues) {
        ...
        checkUnsupportedConfigsPostProcess(parsedValues);
    ...
    private void checkUnsupportedConfigsPostProcess(final Map<String, Object> parsedValues) {
    ...
    ShareConsumerConfig(Map<?, ?> props, boolean doLog) {
    ...
    public ConsumerConfig toConsumerConfig() {
        return new ConsumerConfig(originals());
    }
